...
//$pre_controller = explode('/',$routes[$uri[1]]);
//$controller = $pre_controller[0];
//echo $uri[1];
//echo "<hr>";
//print_r($routes);
//echo "<hr>";
//print_r($routes[$uri[1]]);
//die;
//
//print_r($pre_controller);
//print_r($uri);
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-lg-2">
                    ...
                    <div class="logo">
                        ...
                        <img src="/images/logo/profile-logo.png" alt="">
                ...
                <div class="col-xs-9 col-lg-3">
                    ...
                    <div class="login-wrapper">
                        ...
                        <?php //Если пользователь вошел в систему, показать ему меню сбоку
