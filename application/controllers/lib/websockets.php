...
abstract class WebSocketServer {
  ...
  protected function saveMessage ($date,$time,$from,$to,$message){
      $chat_model = new Chat();
      $msg_data = array('date' => $date, 'time' => $time, 'from' => $from, 'to' =>$to, 'msg' => $message);
      $chat_model->saveMessage($msg_data);
  }
